...
# # -------------------------------------------------
# # Hybrid Auto-login (Persist User via URL)
# # -------------------------------------------------
...
#     st.info("Please login via the sidebar to access your dashboard.")
#     st.stop()
...
#     rows = []
#     issues = client.get_my_issues(max_results=50) # Reduced for speed
#     for issue in issues:
...
#     if not df.empty:
#         fig = px.bar(df, x="Date", y="Hours", color="Issue", title="Workload Distribution")
...
# # ... (Rest of your page logics: Issues, Reports, etc.)
#     # -------------------------------------------------
